...
const CATALOG: { re: RegExp; category: string; code_system: string; code: string; code_display: string }[] = [
  ...
  { re: /\b(?:(?:kidney|renal|urinary)\s+(?:tract\s+)?ultrasound|ultrasound\s+(?:of\s+)?(?:the\s+)?(?:kidneys?|renal|urinary)(?:\s+tract)?|renal\s+u\/s)\b/i, category: "imaging", code_system: "http://snomed.info/sct", code: "16310003", code_display: "Ultrasound of urinary tract" },
  ...
  { re: /\b(?:renal|kidney) (?:profile|function|panel|enzymes?)\b|\bu&e\b|\burea and electrolytes\b/i, category: "laboratory", code_system: "http://snomed.info/sct", code: "302181000", code_display: "Renal profile" },
  ...
  { re: /\b(urine|urinary) culture\b|\b(msu|midstream urine)\b|\bc\s*&\s*s\b\s*(?:urine)?/i, category: "laboratory", code_system: "http://snomed.info/sct", code: "43469005", code_display: "Urine culture" },
