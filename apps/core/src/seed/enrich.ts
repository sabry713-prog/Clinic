...
> = {
  ...
  "MRN-008": [
    { code: "33367005", display: "Coronary angiography", daysAgo: 300, performer: "Dr. Salem Al-Harthi (Dev)", note: "Coronary angiography performed in the catheterization laboratory (cath lab). Report documented." },
  ...
  "MRN-010": [
    ...
    { code: "36969009", display: "Placement of stent in coronary artery", daysAgo: 160, performer: "Dr. Salem Al-Harthi (Dev)", note: "Percutaneous coronary intervention with coronary stent placement performed in the catheterization laboratory (cath lab). Procedure report documented." },
      ...
      for (const p of procedures) {
        await client.query(
          `INSERT INTO hospital.procedure
           ...
           ON CONFLICT (source_system, source_id) DO UPDATE
             SET code_display = EXCLUDED.code_display, note = EXCLUDED.note`,
          [
