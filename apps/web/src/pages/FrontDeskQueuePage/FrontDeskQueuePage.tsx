      ...
      <div className="max-w-4xl mx-auto">
        ...
        {isLoading ? (
          ...
          <div className="bg-slate-900 border border-slate-700 rounded-lg p-8 text-center">
            <p className="text-slate-500 text-sm">No scheduled appointments</p>
          </div>
        ) : (
                ...
                <div key={item.id} className="bg-slate-900 border border-slate-700 rounded-lg p-5" dir="ltr">
                  <div className="flex items-start justify-between gap-4">
                    <div className="space-y-1 flex-1 min-w-0">
                      <p className="text-sm text-white truncate">{item.appointment_type} — {formatDateTime(item.scheduled_at)}</p>
