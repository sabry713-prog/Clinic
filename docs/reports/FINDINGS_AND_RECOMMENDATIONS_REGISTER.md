...
| M03 | Known dev master key fallback not production-gated; customer key provider is a stub | Reject missing/known keys outside isolated tests; implement KMS/HSM wrapping, rotation, recovery (**pre-PHI gate**) |
